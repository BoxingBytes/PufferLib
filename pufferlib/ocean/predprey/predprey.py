...
class PredPrey(pufferlib.PufferEnv):
    def __init__(self, 
                ...
                reward_eat = 0,
                reward_collect_food = 0,
                reward_collect_wood = 0,
                timestep_reward = 0,
                hp_reward_scale = 0,
        ...
        obs_shape = ((2*vision+1)*(2*vision+1)*5)+8
        ...
        for i in range(num_envs):
            ...
            env_id = binding.env_init(
                ...
                reward_collect_food = reward_collect_food,
                reward_collect_wood = reward_collect_wood,
